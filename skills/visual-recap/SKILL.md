...
2. **Classification is checked against the primitives map.** In the repository
   being reviewed, read `docs/contributing/architecture/primitives.yaml` before
...
5. Upsert it into the PR description:
   ...
   node ~/.codex/skills/visual-recap/scripts/upsert-recap-block.mjs <pr-number> <block-file>
