...
ln -s ~/agent-skills/skills/domain-modeling ~/.claude/skills/domain-modeling
...
ln -s ~/agent-skills/skills/prototype ~/.claude/skills/prototype
ln -s ~/agent-skills/skills/prd-to-plan ~/.claude/skills/prd-to-plan
ln -s ~/agent-skills/skills/research ~/.claude/skills/research
ln -s ~/agent-skills/skills/resolving-merge-conflicts ~/.claude/skills/resolving-merge-conflicts
...
| [animate](animate/SKILL.md) | Build web animations from purpose and interaction frequency through properties, easing, timing, interruption, and exit behavior (from [emilkowalski/skills](https://github.com/emilkowalski/skills)) |
| [animate-expo](animate-expo/SKILL.md) | Build Expo and React Native motion with Reanimated, gestures, navigation, haptics, reduced motion, and real-device performance gates (from [emilkowalski/skills](https://github.com/emilkowalski/skills)) |
| [animation-vocabulary](animation-vocabulary/SKILL.md) | Map vague descriptions of motion effects to precise animation terms for prompting and design discussion (from [emilkowalski/skills](https://github.com/emilkowalski/skills)) |
| [apple-design](apple-design/SKILL.md) | Apply Apple's fluid-interface principles to web gesture, spring, depth, typography, feedback, and reduced-motion decisions (from [emilkowalski/skills](https://github.com/emilkowalski/skills)) |
| [ask-sonner](ask-sonner/SKILL.md) | Install, configure, style, and troubleshoot the Sonner React toast library (from [emilkowalski/skills](https://github.com/emilkowalski/skills)) |
| [find-animation-opportunities](find-animation-opportunities/SKILL.md) | Read-only search for high-conviction places where motion would improve an interface, with precise proposed recipes (from [emilkowalski/skills](https://github.com/emilkowalski/skills)) |
| [improve-animations](improve-animations/SKILL.md) | Audit a codebase's motion and produce prioritized, executor-ready improvement plans without modifying source (from [emilkowalski/skills](https://github.com/emilkowalski/skills)) |
| [pick-ui-library](pick-ui-library/SKILL.md) | Explicit-only lookup for an opinionated UI-library choice by frontend task (from [emilkowalski/skills](https://github.com/emilkowalski/skills)) |
| [review-animations](review-animations/SKILL.md) | Explicit-only review of animation and motion code against a strict design-engineering craft bar (from [emilkowalski/skills](https://github.com/emilkowalski/skills)) |
...
| [domain-modeling](domain-modeling/SKILL.md) | Build and sharpen a project's domain glossary and ADRs as decisions crystallize ([mattpocock/skills](https://github.com/mattpocock/skills)) |
...
- **animate**, **animation-vocabulary**, **apple-design**, **find-animation-opportunities**, **improve-animations**, **pick-ui-library**, and **review-animations**: Guidance skills; implementation and inspection use the target project's normal frontend tools. From [emilkowalski/skills](https://github.com/emilkowalski/skills).
- **animate-expo**: Guidance skill; implementation expects the target Expo/React Native app and may use Reanimated, Gesture Handler, Expo Router, and `expo-haptics`. From [emilkowalski/skills](https://github.com/emilkowalski/skills).
- **ask-sonner**: Guidance skill for projects using the Sonner React toast package. From [emilkowalski/skills](https://github.com/emilkowalski/skills).
...
- **domain-modeling**: No dependencies (domain glossary and ADR discipline). From [mattpocock/skills](https://github.com/mattpocock/skills).
...
- **prototype**: No dependencies beyond the current repo's runtime for any throwaway prototype it creates. From [mattpocock/skills](https://github.com/mattpocock/skills).
...
- **research**: No dependencies beyond source access for the research task. From [mattpocock/skills](https://github.com/mattpocock/skills).
- **resolving-merge-conflicts**: No dependencies beyond Git and the repo's normal verification commands. From [mattpocock/skills](https://github.com/mattpocock/skills).
