...
description: Audit recent work history to identify repeated manual workflows worth packaging as skills, custom subagents, or automations, then create only high-confidence missing items. Use when a user asks to look back over recent Codex sessions, memories, rollout summaries, Chronicle, existing skills, custom agents, or automations to find recurring workflows to package.
---

# Project Skill Audit

When this skill is triggered, follow this prompt verbatim:
