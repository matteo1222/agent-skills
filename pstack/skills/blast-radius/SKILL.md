...
6. For a big or wide change, run it as an `arena`. Ask several configured Codex model/effort variants the same question and merge the answers. Different variants catch different real bugs.
