...
const LANES =
	"Ten lanes with `model: gpt-5.6-luna` and `reasoning_effort: max` at the PR head";
const SUB_BLOCKS = [
	"Depends on.",
	"Files.",
	"Build.",
...
const PROGRAM_MARKERS = ["Codex goal", "<absolute-pstack-payload>", /30[- ]minute/, "status message"];
