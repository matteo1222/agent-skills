...
Slack MCP or app tools vary. Check which Slack connector is available and inspect its tool schema first. It may require connector authentication. If authentication fails, stop and report the gap.
