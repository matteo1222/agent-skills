...
Copy this file outside `.codex/pstack/benny/pack/`, for example to `.codex/pstack/benny/feature-map.md`, and set `control.feature_map_path` to the copy. Pack refreshes must not overwrite it.
