...
Copy this file outside `.codex/pstack/benny/pack/`, for example to `.codex/pstack/benny/routing.md`, and replace every placeholder. Point `routing.map_path` at the copy. Pack refreshes must not overwrite it.
...
- A reroute tells the reporter where to go. The scheduled task never cross-posts.
