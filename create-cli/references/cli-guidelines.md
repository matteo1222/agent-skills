...
> **Attribution**: Condensed from [clig.dev](https://clig.dev/) via [steipete/agent-scripts](https://github.com/steipete/agent-scripts).
> Original authors: Aanand Prasad, Ben Firshman, Carl Tashian, Eva Parish.
