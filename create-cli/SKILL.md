...
> **Attribution**: This skill is adapted from [steipete/agent-scripts](https://github.com/steipete/agent-scripts) by Peter Steinberger.
> CLI guidelines based on [clig.dev](https://clig.dev/).

Design CLI surface area (syntax + behavior), human-first, script-friendly.

## Do This First

- Read `{baseDir}/references/cli-guidelines.md` and apply it as the default rubric.
